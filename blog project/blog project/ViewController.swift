...
class ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        let likesButton = UIBarButtonItem(image: UIImage(systemName: "heart.fill"), style: .plain, target: self, action: #selector(likesButtonAction))
        likesButton.tintColor = .red
        navigationItem.rightBarButtonItem = likesButton
        
    }
    @objc func likesButtonAction() {
        let vc = BlogLikesTableViewController()
